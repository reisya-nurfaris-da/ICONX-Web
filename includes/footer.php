            ...
            <div class="row gx-0 gy-6 g-lg-10">
                <div class="col-lg-5">
                    <a href="landing-page.html" class="app-brand-link mb-6">
                        ...
                        <span class="app-brand-text demo text-white fw-bold ms-2 ps-1">ICONX</span>
                    </a>
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-4">
                            <a
                                ...
                                target="_blank"
                                class="footer-link">Vertical Layout</a>
                        </li>
                        <li class="mb-4">
                            <a
                        ...
                        <li class="mb-4">
                            <a
                                href="../vertical-menu-template-bordered/index.html"
                                target="_blank"
                                class="footer-link">Bordered Layout</a>
                        </li>
                        <li class="mb-4">
                            <a
                                href="../vertical-menu-template-semi-dark/index.html"
                                target="_blank"
                                class="footer-link">Semi Dark Layout</a>
                        </li>
                        <li>
                            <a
                                href="../vertical-menu-template-dark/index.html"
                                target="_blank"
                                class="footer-link">Dark Layout</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
